...
```python
# for level 1 i need to insert something like
# "xay" in which: a is used as a separator
# ord(x) + ord(y) > 180
print(ord("z"))
# let's use "zaz" then...
# OK! max points
...
# for level 2...:
# input -> list
# input[2] is shifted by 2 chars on the right
# in -> str and "RI" replaced but...
# i have to insert "SPRITZ" but R has to be R-2
print(chr(ord("R") - 2))
# "SPPITZ" no but.. maybe replace is not recursive?
# "SPPRIITZ" yes! REPLACE IS NOT RECURSIVE
```